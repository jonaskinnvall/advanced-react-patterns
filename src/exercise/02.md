...
- The compound component pattern and how it can be used to provide the user with
  a flexible and powerful API for reusable components.
  - The compound components share implicit state with the parent and becomes
    easily changlable and extendable using this pattern compared to passing
    props to the parent and handeling everything there
- Also got some insight into how React.Children and React.cloneElement works and
  can be used in this type of scenario
